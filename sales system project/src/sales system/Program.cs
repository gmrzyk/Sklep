...
class Program
{
    ...
    static void RemoveProduct()
    {
        ...
        List<Product> products = LoadProducts();
        products.RemoveAll(p => p.Name != null && p.Name.Equals(name, StringComparison.OrdinalIgnoreCase));
        SaveProducts(products);
    ...
    static void RemoveCustomer()
    {
        ...
        {
            Console.WriteLine("Nieprawidłowe imię klienta.");
            Console.ReadKey();
            return;
        }

        List<Customer> customers = LoadCustomers();
        customers.RemoveAll(c => c.FirstName != null && c.FirstName.Equals(firstName, StringComparison.OrdinalIgnoreCase));
        SaveCustomers(customers);
    ...
    static List<Product> LoadProducts()
    {
        ...
        {
            string jsonContent = File.ReadAllText(productFile);
            return JsonSerializer.Deserialize<List<Product>>(jsonContent) ?? new List<Product>();
        }
    ...
    static List<Customer> LoadCustomers()
    {
        ...
        {
            string jsonContent = File.ReadAllText(customerFile);
            return JsonSerializer.Deserialize<List<Customer>>(jsonContent) ?? new List<Customer>();
        }
